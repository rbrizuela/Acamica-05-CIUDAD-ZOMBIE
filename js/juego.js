...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 140, 400, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 120, 280, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 200, 430, 30, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 350, 470, 15, 30, 4),
    new Obstaculo('imagenes/bache.png', 440, 400, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 520, 430, 30, 30, 6),
    new Obstaculo('imagenes/valla_horizontal.png', 550, 430, 30, 30, 6),
    new Obstaculo('imagenes/auto_rojo_izquierda.png', 350, 250, 30, 15, 8),
    new Obstaculo('imagenes/bache.png', 320, 150, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 490, 80, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 820, 150, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 430, 30, 30, 6),
    new Obstaculo('imagenes/valla_horizontal.png', 790, 430, 30, 30, 6)
  ...
  enemigos: [
    ...
    new ZombieConductor('imagenes/tren_vertical.png', 644, 100, 30, 90, 1, rangoMov, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 674, 400, 30, 90, 1, rangoMov, 'v'),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 325, 90, 30, 2, rangoMov, 'h')
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarImagen('imagenes/BanderaCuadros.png', 760, 543, 126, 20);
